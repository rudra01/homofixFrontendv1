    ...
    <header className="bg-white top-0 sticky z-[1200] px-6 shadow-sm">
      <nav className="mx-auto flex max-w-7xl items-center  justify-between py-3  z-[1200] lg:px-8" aria-label="Global">
        ...
        >
          ...
          <div className={`${subMenu} origin-top-right absolute z-[1500] right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none`}>
            <Link
              href="/account"
